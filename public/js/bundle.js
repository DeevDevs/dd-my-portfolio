...
var SharedView = /*#__PURE__*/function () {
  ...
  function SharedView() {
    ...
    _defineProperty(this, "errorWindowMessage", document.querySelector('.error-message'));
  ...
  _createClass(SharedView, [{
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios({
                  ...
                  url: "/switch-language?lang=".concat(currentLang, "&page=").concat(currentPage)
                });
              ...
              case 10:
                ...
                console.log(_context.t0); // add error handler
      ...
      if (e.target.closest('.footer-address-btn')) {
        if (this.footerWindow !== 'address') {
          if (window.innerWidth < 1080) {
            ...
            this.footerWindow = 'address'; // console.log('switched');
          }
        }
      }
    ...
    value: function () {
      var _submitFooterMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        ...
        var messageArr, messageObject, res;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                ...
                this.errorWindowMessage.textContent = this.switchLangBtn.textContent === 'ru' ? "Message was successfully sent. I will contact you soon." : "\u041E\u0442\u043B\u0438\u0447\u043D\u043E! \u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E. \u042F \u0441\u043A\u043E\u0440\u043E \u0441 \u0412\u0430\u043C\u0438 \u0441\u0432\u044F\u0436\u0443\u0441\u044C.";
              ...
              case 22:
                ...
                this.errorWindowMessage.textContent = this.switchLangBtn.textContent === 'ru' ? "Oops, something went wrong. Please, check your internet connection." : "\u0423\u043F\u0441, \u0447\u0442\u043E-\u0442\u043E \u043F\u043E\u0448\u043B\u043E \u043D\u0435 \u0442\u0430\u043A. \u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u043F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0438\u043D\u0442\u0435\u0440\u043D\u0435\u0442 \u0441\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u0435.";
                return _context2.abrupt("return", this._displayErrorMessageBox());

              case 27:
                if (!(_context2.t0.message === 'Already tried')) {
                  _context2.next = 30;
                  break;
                }

                this.errorWindowMessage.textContent = this.switchLangBtn.textContent === 'ru' ? "You have already tried to contact me via this form. Please, contact me via email." : "\u0412\u044B \u0443\u0436\u0435 \u043F\u0440\u043E\u0431\u043E\u0432\u0430\u043B\u0438 \u0441\u0432\u044F\u0437\u0430\u0442\u044C\u0441\u044F \u0441\u043E \u043C\u043E\u0439 \u0447\u0435\u0440\u0435\u0437 \u044D\u0442\u0443 \u0444\u043E\u0440\u043C\u0443. \u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u0441\u0432\u044F\u0437\u0430\u0442\u044C\u0441\u044F \u0447\u0435\u0440\u0435\u0437 \u044D\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u0443\u044E \u043F\u043E\u0447\u0442\u0443.";
                return _context2.abrupt("return", this._displayErrorMessageBox());

              case 30:
                if (!(_context2.t0.response.data.errorMessage && _context2.t0.response.data.errorMessage === 'Duplicate')) {
                  _context2.next = 33;
                  break;
                }
              ...
              case 33:
                if (!(_context2.t0.response.data.errorMessage && _context2.t0.response.data.errorMessage.startsWith('VisitorMessages'))) {
                  _context2.next = 36;
                  break;
                }

                this.errorWindowMessage.textContent = this.switchLangBtn.textContent === 'ru' ? "Please, provide a valid email address." : "\u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0439\u0442\u0435 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u044E\u0449\u0443\u044E \u044D\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u0443\u044E \u043F\u043E\u0447\u0442\u0443.";
                return _context2.abrupt("return", this._displayErrorMessageBox());

              case 36:
                if (!(_context2.t0.response.data.errorMessage && _context2.t0.response.data.errorMessage === 'DB full')) {
                  _context2.next = 39;
                  break;
                }

                this.errorWindowMessage.textContent = this.switchLangBtn.textContent === 'ru' ? "Unfortunately, your message cannot be sent now. Please, try again later or contact me via email." : "\u041A \u0441\u043E\u0436\u0430\u043B\u0435\u043D\u0438\u044E, \u044F \u043D\u0435 \u043C\u043E\u0433\u0443 \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0432\u0430\u0448\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u0441\u0435\u0439\u0447\u0430\u0441. \u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435, \u0438\u043B\u0438 \u0441\u0432\u044F\u0436\u0438\u0442\u0435\u0441\u044C \u0441\u043E \u043C\u043D\u043E\u0439 \u0447\u0435\u0440\u0435\u0437 \u044D\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u0443\u044E \u043F\u043E\u0447\u0442\u0443.";
                return _context2.abrupt("return", this._displayErrorMessageBox());
    ...
    key: "_displayErrorMessageBox",
    value: function _displayErrorMessageBox() {
      var _this3 = this;

      this._makeElementAppear(this.errorWindow, 200, 'block');

      setTimeout(function () {
        _this3._makeElementDisappear(_this3.errorWindow, 200);
      }, 3000);
    }
  }, {
    key: "_changeTheme",
...
var ProjectsView = /*#__PURE__*/function () {
  ...
  _createClass(ProjectsView, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                }.bind(this), 600); // observer.unobserve(this.wheelContainer);
    ...
    value: function displayFrontProjectName(projectId) {
      ...
      this.btnSwitchLanguage.textContent === 'ru' ? this.mainProjectName.textContent = this.projectNames[0][idNum - 1] : this.mainProjectName.textContent = this.projectNames[1][idNum - 1];
            ...
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                return axios({
                  ...
                  url: "/details?prnumber=".concat(idNum)
                });
...
var thisPageIs = document.getElementById('this-page').textContent;
